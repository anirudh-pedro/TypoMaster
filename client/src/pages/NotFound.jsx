    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="min-h-[calc(100vh-64px)] flex flex-col justify-center items-center px-4 py-12">
        <div className="text-center">
          <FaKeyboard className="mx-auto h-16 w-16 text-indigo-600" />
          <h1 className="mt-4 text-8xl font-extrabold text-indigo-600 tracking-tighter">
            404
          </h1>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-md p-4 max-w-lg w-full">
          <div className="grid grid-cols-12 gap-1 text-center">
            {['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P', '[', ']'].map((key) => (
              <div key={key} className="col-span-1 bg-gray-200 rounded p-2 text-xs sm:text-sm font-medium text-gray-700">
                {key}
              </div>
            ))}
          </div>
          ...
          <div className="mt-1">
            <div className="bg-indigo-600 rounded-md p-2 text-white text-center text-sm">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          <button 
            ...
            className="flex items-center justify-center px-5 py-3 border border-indigo-600 text-base font-medium rounded-md text-indigo-600 bg-transparent hover:bg-indigo-50 transition"
          >
